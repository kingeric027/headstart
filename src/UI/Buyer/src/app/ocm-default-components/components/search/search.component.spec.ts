...
import { SearchComponent } from 'src/app/ocm-default-components/components/search/search.component';
...
describe('SearchComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: ActivatedRoute, useValue: activatedRoute }, { provide: Router, useValue: router }],
  ...
  describe('onFormChanges', () => {
    ...
    it('should emit search after 500ms of form change', fakeAsync(() => {
      component['onFormChanges']();
