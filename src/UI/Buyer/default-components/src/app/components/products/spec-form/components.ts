...
import { SpecFormLabelComponent } from './spec-form-label/spec-form-label.component';
import { SpecFormRangeComponent } from './spec-form-range/spec-form-range.component';

export const specFormComponents = {
  ...
  label: SpecFormLabelComponent,
  range: SpecFormRangeComponent,
};
