export class ErrorConstants {
    public static get orderSubmittedError(): string { return 'This order has already been submitted' }
    public static get orderNotAccessibleError(): string { return 'You no longer have access to this order' }
}
