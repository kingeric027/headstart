...
import { OCMCheckout } from './containers/checkout/checkout.component';
...
@NgModule({
  ...
  declarations: [OrderConfirmationComponent, CartWrapperComponent, OCMCheckout, CheckoutWrapperComponent],
})
