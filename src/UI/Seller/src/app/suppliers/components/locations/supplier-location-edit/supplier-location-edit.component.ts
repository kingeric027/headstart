...
import { Address, OcProductService, ListPage } from '@ordercloud/angular-sdk';
...
export class SupplierLocationEditComponent implements OnChanges {
  ...
  constructor(private middleware: MiddlewareAPIService, private activatedRoute: ActivatedRoute) {}
