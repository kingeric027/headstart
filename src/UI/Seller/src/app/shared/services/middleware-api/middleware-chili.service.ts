...
export class ChiliService {
  ...
  async getDocuments(): Promise<TecraDocument[]> {
    ...
    return await this.http
      .get<TecraDocument[]>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  async getDocumentsByFolder(folderName: string): Promise<TecraDocument[]> {
    const url = `${this.appConfig.middlewareUrl}/tecra/documents/byfolder/${folderName}`
    return await this.http
      .get<TecraDocument[]>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  ...
  async listChiliConfigs(): Promise<ListPage<ChiliConfig>> {
    ...
    return await this.http
      .get<ListPage<ChiliConfig>>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  ...
  async saveChiliConfig(config: ChiliConfig): Promise<ChiliConfig> {
    const url = `${this.appConfig.middlewareUrl}/chili/config`
    return await this.http
      .post<ChiliConfig>(url, config, { headers: this.buildHeaders() })
      .toPromise()
  }
  async deleteChiliConfig(id: string) {
    const url = `${this.appConfig.middlewareUrl}/chili/config/${id}`
    return await this.http
      .delete<ChiliConfig>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  ...
  async saveChiliSpec(spec: ChiliSpec): Promise<ChiliSpec> {
    ...
    return await this.http
      .post<ChiliSpec>(url, spec, { headers: this.buildHeaders() })
      .toPromise()
  }
  async deleteChiliSpec(id: string) {
    const url = `${this.appConfig.middlewareUrl}/chili/specs/${id}`
    return await this.http
      .delete<ChiliSpec>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  ...
  async saveChiliSpecOption(
    ...
    return await this.http
      .post<ChiliSpecOption>(url, spec, { headers: this.buildHeaders() })
      .toPromise()
  }
  async updateChiliSpecOption(
    ...
    return await this.http
      .put<ChiliSpecOption>(url, spec, { headers: this.buildHeaders() })
      .toPromise()
  }
  async deleteChiliSpecOption(specID: string, optionID: string) {
    ...
    return await this.http
      .delete<ChiliSpecOption>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
  ...
  async getChiliTemplate(id: string): Promise<ChiliTemplate> {
    ...
    return await this.http
      .get<ChiliTemplate>(url, { headers: this.buildHeaders() })
      .toPromise()
  }
}
