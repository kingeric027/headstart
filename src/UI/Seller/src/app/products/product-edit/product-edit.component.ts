...
export class ProductEditComponent implements OnInit {
  ...
  createProductForm(marketPlaceProduct: MarketPlaceProduct) {
    this.productForm = new FormGroup({
      ...
      ShipHeight: new FormControl(marketPlaceProduct.ShipHeight, [Validators.required, Validators.min(0)]),
      ShipWidth: new FormControl(marketPlaceProduct.ShipWidth, [Validators.required, Validators.min(0)]),
      ShipLength: new FormControl(marketPlaceProduct.ShipLength, [Validators.required, Validators.min(0)]),
      ShipWeight: new FormControl(marketPlaceProduct.ShipWeight, [Validators.required, Validators.min(0)]),
