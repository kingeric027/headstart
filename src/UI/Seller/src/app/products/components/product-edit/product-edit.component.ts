  ...
  createProductForm(superMarketplaceProduct: SuperMarketplaceProduct) {
    if (superMarketplaceProduct.Product) {
      this.productForm = new FormGroup({
        ...
        MinQuantity: new FormControl(superMarketplaceProduct.PriceSchedule.MinQuantity, [Validators.min(0)]),
        MaxQuantity: new FormControl(superMarketplaceProduct.PriceSchedule.MaxQuantity),
