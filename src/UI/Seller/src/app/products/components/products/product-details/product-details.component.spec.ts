...
import { ProductDetailsComponent } from '@app-seller/products/components/products/product-details/product-details.component';
...
describe('ProductDetailsComponent', () => {
  ...
  describe('updateProduct', () => {
    it('should update using existing productID', () => {
      ...
      expect(productService.Patch).toHaveBeenCalledWith(component.productID, mock);
    });
  });
});
