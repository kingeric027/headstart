...
const routes: Routes = [
  ...
  { path: ':storefrontID/pages', component: StorefrontTableComponent },
  { path: ':storefrontID/pages/new', component: StorefrontTableComponent },
  { path: ':storefrontID/pages/:pageID', component: StorefrontTableComponent },
];
