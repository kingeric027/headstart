import { Component, ChangeDetectorRef, NgZone, AfterViewChecked, OnInit } from '@angular/core';
import { ResourceCrudComponent } from '@app-seller/shared/components/resource-crud/resource-crud.component';
import { Router, ActivatedRoute } from '@angular/router';
import { StorefrontsService } from '../../storefronts/storefronts.service';
import { JDocument, AssetUpload } from '@ordercloud/headstart-sdk';
...
export class StorefrontPageTableComponent extends ResourceCrudComponent<JDocument> implements AfterViewChecked, OnInit {
  route = 'pages';
  ...
  ngOnInit(): any {
    ...
    this.parentResourceIDSubject.pipe(takeWhile(() => this.alive)).subscribe(parentResourceID => {
      if (parentResourceID) {
  ...
  setEditorOptions(clientID: string): void {
    ...
    if (clientID === 'A5231DF1-2B00-4002-AB40-738A9E2CEC4B') {
      ...
      this.editorOptions.content_css = ['https://marketplace-buyer-ui-test.azurewebsites.net/styles.f73343b62778747ba6b8.css']
    } else if (clientID === 'A2E62264-B6FB-4C25-8507-79A58A35BE85') {
      // eslint-disable-next-line @typescript-eslint/camelcase, camelcase
      this.editorOptions.content_css = ['https://sebrandsmarketplace-basecamp.azurewebsites.net/styles.e0ac2f58bbaf77939ee1.css']
    } else if (clientID === '997F5753-4C11-4F5F-9B40-6AC843638BA2') {
      // eslint-disable-next-line @typescript-eslint/camelcase, camelcase
      this.editorOptions.content_css = ['https://sebrandsmarketplace-bar.azurewebsites.net/styles.5b06344ef1424055c881.css']
    } else {
      // eslint-disable-next-line @typescript-eslint/camelcase, camelcase
      this.editorOptions.content_css = ['https://sebrandsmarketplace-anytime.azurewebsites.net/styles.5e6471eb0cec93cf2823.css']
    }
  }

  private async redirectToFirstParentIfNeeded(parentResourceID: string): Promise<void> {
