...
import { BuyerUserPermissionsAssignments } from './components/users/buyer-user-permissions-assignments/buyer-user-permissions-assignments.component';
...
@NgModule({
  ...
  declarations: [
    ...
    BuyerUserPermissionsAssignments,
  ],
})
