...
var AppGeographyService = /** @class */ (function () {
    function AppGeographyService() {
        this.states = [
    ...
    AppGeographyService.prototype.getStates = function (countryCode) {
        return this.states.filter(function (state) { return state.country === countryCode; });
    };
    AppGeographyService.prototype.getCountries = function () {
        return [
    ...
    AppGeographyService = __decorate([
        Injectable({
            providedIn: 'root',
        })
    ], AppGeographyService);
    return AppGeographyService;
}());
export { AppGeographyService };
