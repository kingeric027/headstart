...
namespace Marketplace.Common.Services.Zoho.Models
{
    ...
    public class ZohoVendorCredit
    {
        ...
        public List<ZohoComment> comments { get; set; }
        /// <summary>
        /// Gets or sets the vendor_credit_refunds.
        /// </summary>
        /// <value>The vendor_credit_refunds.</value>
        public List<ZohoVendorCreditRefund> vendor_credit_refunds { get; set; }
        /// <summary>
        /// Gets or sets the bills_credited.
        /// </summary>
        /// <value>The bills_credited.</value>
        public List<ZohoBill> bills_credited { get; set; }
    }
}
