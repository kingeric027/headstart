...
{
    /// <summary>
    /// Class ZohoEstimateSettings.
    /// </summary>
    public class ZohoEstimateSettings
    {
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is auto_generate.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is is_discount_before_tax.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is terms_to_invoice.
        /// </summary>
        /// <value><c>true</c> if terms_to_invoice; otherwise, <c>false</c>.</value>
        public bool terms_to_invoice { get; set; }
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is notes_to_invoice.
        /// </summary>
        /// <value><c>true</c> if notes_to_invoice; otherwise, <c>false</c>.</value>
        public bool notes_to_invoice { get; set; }
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is warn_estimate_to_invoice.
        /// </summary>
        /// <value><c>true</c> if warn_estimate_to_invoice; otherwise, <c>false</c>.</value>
        public bool warn_estimate_to_invoice { get; set; }
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is is_sales_person_required.
        /// </summary>
        /// <value><c>true</c> if is_sales_person_required; otherwise, <c>false</c>.</value>
        public bool is_sales_person_required { get; set; }
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEstimateSettings"/> is convert_to_invoice.
        /// </summary>
