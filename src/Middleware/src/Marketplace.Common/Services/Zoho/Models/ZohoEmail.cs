...
namespace Marketplace.Common.Services.Zoho.Models
{
    ...
    public class ZohoEmail
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEmail" /> is gateways_configured.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoEmail" /> is gateways_associated.
        /// </summary>
        ...
        public List<ZohoEmailTemplate> emailtemplates { get; set; }
        /// <summary>
        /// Gets or sets the to_contacts.
        /// </summary>
        /// <value>The to_contacts.</value>
        public List<ZohoToContact> to_contacts { get; set; }
        /// <summary>
        ...
        public List<ZohoFromEmail> from_emails { get; set; }
        /// <summary>
