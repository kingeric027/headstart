...
{
    /// <summary>
    /// Used to define the model object of ZohoUser.
    /// </summary>
    public class ZohoUser
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZohoUser" /> is is_current_user.
        /// </summary>
        ...
        public List<ZohoEmailId> email_ids { get; set; }
        /// <summary>
