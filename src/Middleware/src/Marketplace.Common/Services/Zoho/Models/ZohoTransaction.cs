...
namespace Marketplace.Common.Services.Zoho.Models
{
    ...
    public class ZohoTransaction
    {
        ...
        public List<ZohoTransaction> associated_transactions { get; set; }
        /// <summary>
        ...
        public List<ZohoImportedTransaction> imported_transactions { get; set; }
    }
}
