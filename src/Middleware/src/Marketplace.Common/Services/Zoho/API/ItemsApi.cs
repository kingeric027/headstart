...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    ///     Get the list of the items from the ZohoOrganization or details of the specified item,<br></br>
    ...
    public class ItemsApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter items by status.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Active</i> and <i>FourOverStatus.Inactive</i></td></tr>
        ...
        public ZohoItemList GetItems(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoLineItem object.</returns>
        public ZohoLineItem Get(string item_id)
        {
        ...
        /// Create a new item.
        /// </summary>
        /// <param name="item_info">The item_info is the ZohoLineItem object with name and rate as mandatory attributes.</param>
        /// <returns>ZohoLineItem object.</returns>
        public ZohoLineItem Create(ZohoLineItem item_info, Dictionary<object, object> parameters = null)
        {
            string url = baseAddress;
        ...
        /// </summary>
        /// <param name="item_id">The item_id is the identifier of the item.</param>
        /// <param name="update_info">The update_info is the ZohoLineItem object which contains the updation information.</param>
        /// <returns>ZohoLineItem object.</returns>
        public ZohoLineItem Update(string item_id,ZohoLineItem update_info)
        {
            string url = baseAddress + "/" + item_id;
