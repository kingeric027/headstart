...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class ChartOfAccountsApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter accounts based on its account type and status.<br></br>Allowed Values: <i>AccountType.All, AccountType.Active, AccountType.Inactive, AccountType.Asset, AccountType.Liability, AccountType.Equity, AccountType.Income</i> and <i>AccountType.ZohoExpense</i></td></tr>
        ...
        public ZohoChartOfAccountList GetChartOfAcounts(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoChartOfAccount object.</returns>
        public ZohoChartOfAccount Get(string account_id)
        {
        ...
        /// </summary>
        /// <param name="new_account_info">The new_account_info is the ZohoChartOfAccount object which contains the specified information to create an account with account_type as mandatory parameter.</param>
        /// <returns>ZohoChartOfAccount object.</returns>
        public ZohoChartOfAccount Create(ZohoChartOfAccount new_account_info)
        {
            string url = baseAddress;
        ...
        /// <param name="update_info">The update_info is the ZohoChartOfAccount object which contains the information regarding the changes with account_type as a mandatory parameter.</param>
        /// <returns>ZohoChartOfAccount object.</returns>
        public ZohoChartOfAccount Update(string account_id, ZohoChartOfAccount update_info)
        {
            string url = baseAddress + "/" + account_id;
        ...
        /// <tr><td>filter_by</td><td>Filter transactions based on its type.<br></br>Allowed Values: <i>TransactionType.All, TransactionType.ZohoBaseCurrencyAdjustment, TransactionType.Bills, TransactionType.ZohoVendorPayment, TransactionType.CardPayment, TransactionType.CreditNotes, TransactionType.CreditNoteRefund, TransactionType.Deposit, TransactionType.ZohoExpense, TransactionType.ZohoInvoice, TransactionType.ZohoJournal, TransactionType.ZohoCustomerPayment, TransactionType.TransferFund</i> and <i>TransactionType.ZohoOpeningBalance</i></td></tr>
