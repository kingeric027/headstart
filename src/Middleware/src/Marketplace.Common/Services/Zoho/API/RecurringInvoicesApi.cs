...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    ///     EchoStop an active recurring invoice,<br></br>
    ...
    public class RecurringInvoicesApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter recurring invoices by any status.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Active, FourOverStatus.Stopped</i> and <i>FourOverStatus.Expired</i></td></tr>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoRecurringInvoiceList.</returns>
        public ZohoRecurringInvoiceList GetRecurringInvoices(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoRecurringInvoice object.</returns>
        public ZohoRecurringInvoice Get(string recurring_invoice_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoRecurringInvoiceInfo">The newZohoRecurringInvoiceInfo is the ZohoRecurringInvoice object with recurrence_name,customer_id and recurrence_frequency as mandatory attributes.</param>
        /// <returns>ZohoRecurringInvoice object.</returns>
        public ZohoRecurringInvoice Create(ZohoRecurringInvoice newZohoRecurringInvoiceInfo)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoRecurringInvoiceInfo);
        ...
        /// </summary>
        /// <param name="recurring_invoice_id">The recurring_invoice_id is the identifier of the recuuring invoice.</param>
        /// <param name="update_info">The update_info is the ZohoRecurringInvoice object which contains the updation information.</param>
        /// <returns>ZohoRecurringInvoice object.</returns>
        public ZohoRecurringInvoice Update(string recurring_invoice_id, ZohoRecurringInvoice update_info)
        {
            string url = baseAddress + "/" + recurring_invoice_id;
        ...
        public ZohoCommentList GetComments(string recurring_invoice_id)
        {
