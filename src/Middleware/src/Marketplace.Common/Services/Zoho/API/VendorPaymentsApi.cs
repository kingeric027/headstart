...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class VendorPaymentsApi:Api
    {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoVendorPaymentList object.</returns>
        public ZohoVendorPaymentList GetVendorPayments(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoVendorPayment object.</returns>
        public ZohoVendorPayment Get(string payment_id)
        {
        ...
        /// </summary>
        /// <param name="new_vendorpayment_info">The new_vendorpayment_info is the ZohoVendorPayment object with vendor_id and amount as mandatory attributes.</param>
        /// <returns>ZohoVendorPayment object.</returns>
        public ZohoVendorPayment Create(ZohoVendorPayment new_vendorpayment_info)
        {
            string url = baseAddress;
        ...
        /// </summary>
        /// <param name="payment_id">The payment_id is the identifier of the vendor payment.</param>
        /// <param name="update_info">The update_info is the ZohoVendorPayment object which contains the updation information.</param>
        /// <returns>ZohoVendorPayment object.</returns>
        public ZohoVendorPayment Update(string payment_id, ZohoVendorPayment update_info)
        {
            string url = baseAddress + "/" + payment_id;
