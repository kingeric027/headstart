...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class CustomerPaymentsApi:Api
    {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoCustomerPaymentList object.</returns>
        public ZohoCustomerPaymentList GetCustomerPayments(Dictionary<object, object> parameters)
        {
        ...
        public ZohoCustomerPayment Get(string payment_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoCustomerPaymentInfo">The newZohoCustomerPaymentInfo is the Customerpayment object which having the info to made payment with date and amount as mandatory attributes.</param>
        /// <returns>Customerpayment object.</returns>
        public ZohoCustomerPayment Create(ZohoCustomerPayment newZohoCustomerPaymentInfo)
        {
            string address = baseAddress ;
            var json = JsonConvert.SerializeObject(newZohoCustomerPaymentInfo);
        ...
        /// <returns>Customerpayment object.</returns>
        public ZohoCustomerPayment Update(string payment_id, ZohoCustomerPayment update_info)
        {
            string address = baseAddress+"/"+payment_id;
