...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class ExpensesApi:Api
    {
        ...
        /// <tr>filter_by<td></td><td>Filter expenses by expense status.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Billable, FourOverStatus.Nonbillable, FourOverStatus.Reimbursed, FourOverStatus.Invoiced</i> and <i>FourOverStatus.Unbilled</i></td></tr>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoExpenseList object.</returns>
        public ZohoExpenseList GetExpenses(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoExpense object.</returns>
        public ZohoExpense Get(string expense_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoExpense">The newZohoExpense is the ZohoExpense object which contains the new expense information with account_id and amount as mandatory attributes.</param>
        ...
        /// <returns>ZohoExpense object.</returns>
        public ZohoExpense Create(ZohoExpense newZohoExpense, string receipt_path)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoExpense);
        ...
        /// </summary>
        /// <param name="expense_id">The expense_id is the identifier of the expense.</param>
        /// <param name="update_info">The update_info is the ZohoExpense object which contains the update information.</param>
        /// <param name="receipt_path">The receipt_path is the path of the file which is going to be attaches as a receipt to the expense.</param>
        /// <returns>ZohoExpense object.</returns>
        public ZohoExpense Update(string expense_id, ZohoExpense update_info, string receipt_path)
        {
            string url = baseAddress+"/"+expense_id;
        ...
        public ZohoCommentList GetComments(string expense_id)
        {
