...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    /// This Api is used to get <br>The bank rules list</br><br>The details of the specified ZohoRule</br>
    /// It is used to either update or delete the specified Bank ZohoRule
    /// </summary>
    public class BankRulesApi:Api
    {
        ...
        /// <returns>ZohoRuleList object.</returns>
        public ZohoRuleList GetRules(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoRule object.</returns>
        public ZohoRule Get(string rule_id)
        {
            string url = baseAddress + "/" + rule_id;
        ...
        /// </summary>
        /// <param name="zohoRuleInfo">The zohoRuleInfo is the rule object which contains the rule_name,target_account_id,apply_to,criteria_type,field,comparator and record_as parameters as the mandatory.<br></br>
        ...
        /// </param>
        /// <returns>ZohoRule object.</returns>
        public ZohoRule Create(ZohoRule zohoRuleInfo)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(zohoRuleInfo);
        ...
        /// <returns>ZohoRule object.</returns>
        public ZohoRule Update(string rule_id, ZohoRule update_info)
        {
            string url = baseAddress + "/" + rule_id;
