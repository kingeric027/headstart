...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class CreditNotesApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter credit notes by statuses.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Open, FourOverStatus.DRAFT, FourOverStatus.Closed</i> and <i>FourOverStatus.Void</i></td></tr>
        ...
        public ZohoCreditNoteList GetCreditnotes(Dictionary<object, object> parameters)
        {
        ...
        public ZohoCreditNote Get(string creitnote_id, Dictionary<object, object> parameters)
        {
        ...
        /// </table></param>
        /// <returns>Creditnote object.</returns>
        public ZohoCreditNote Create(ZohoCreditNote new_creditnote_info, Dictionary<object, object> parameters)
        {
            string url = baseAddress;
        ...
        /// </param>
        /// <returns>Creditnote object.</returns>
        public ZohoCreditNote Update(string creditnote_id, ZohoCreditNote update_info, Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="mail_content_info">The mail_content_info is the ZohoEmailNotification object with to_mail_ids,subject and body as mandatory parameters.</param>
        ...
        public string SendEmail(string creditnote_id, ZohoEmailNotification mail_content_info, Dictionary<object, object> parameters)
        {
        ...
        /// <returns>List of ZohoEmailHistory object.</returns>
        public ZohoEmailHistoryList GetEmailHistory(string creditnote_id)
        {
        ...
        public ZohoEmail GetEmailContent(string creditnote_id, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/" + creditnote_id + "/email";
            var responce = ZohoHttpClient.get(url, getQueryParameters(parameters));
        ...
        /// <summary>
        /// Updates the billing ZohoAddress for an existing credit note alone. You can set this ZohoAddress as default billing ZohoAddress for your customer by specifying 'is_update_customer' node as true.
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="update_info">The update_info is the ZohoAddress object which contains the changes information.</param>
        /// <returns>System.String.<br></br>the success message is "Billing ZohoAddress updated"</returns>
        public string UpdateBillingAddress(string creditnote_id, ZohoAddress update_info)
        {
            string url = baseAddress + "/" + creditnote_id + "/ZohoAddress/billing";
            var json = JsonConvert.SerializeObject(update_info);
        ...
        /// <summary>
        /// Updates the shipping ZohoAddress for an existing credit note alone. You can set this ZohoAddress as default shipping ZohoAddress for your customer by specifying 'is_update_customer' node as true.
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="update_info">The update_info is the ZohoAddress object which contains the changes information.</param>
        /// <returns>System.String.<br></br>The success message is "Shipping ZohoAddress updated"</returns>
        public string UpdateShippingAddress(string creditnote_id, ZohoAddress update_info)
        {
...
//---------------------------------------------------------------------------------------------
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <returns>List of ZohoCreditedInvoice object.</returns>
        public ZohoCreditedInvoiceList GetInvoicesCredited(string creditnote_id)
        {
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the creditnote.</param>
        /// <param name="invoicesToZohoApply">The invoicesToZohoApply is the ZohoApplyToInvoices object which is having the information regarding for which invoices the specifed creditnote is going to apply with invoice_id and amount_applied are mandatory parameters.</param>
        /// <returns>List of ZohoCreditedInvoice object.</returns>
        public ZohoCreditedInvoiceList CreditToInvoices(string creditnote_id, ZohoApplyToInvoices invoicesToZohoApply)
        {
            string url = baseAddress + "/" + creditnote_id + "/invoices";
            var json = JsonConvert.SerializeObject(invoicesToZohoApply);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
...
//-------------------------------------------------------------------------------------------------
        ...
        public ZohoCreditNoteRefundList GetCreditnoteRefunds(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>CreditnoteRefundList object.</returns>
        public ZohoCreditNoteRefundList GetRefundsOfCrreditnote(string creditnote_id)
        {
        ...
        public ZohoCreditNote GetCreditnoteRefund(string creditnote_id, string creditnote_refund_id)
        {
        ...
        /// <returns>Creditnote object.</returns>
        public ZohoCreditNote AddRefund(string creditnote_id, ZohoCreditNote refund_details)
        {
            string url = baseAddress + creditnote_id + "/refunds";
        ...
        /// <param name="update_info">The update_info is the Creditnote object which is having the updation details.</param>
        /// <returns>Creditnote object.</returns>
        public ZohoCreditNote UpdateRefund(string creditnote_id, string creditnote_refund_id, ZohoCreditNote update_info)
        {
            string url = baseAddress + "/" + creditnote_id + "/refunds/"+creditnote_refund_id;
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
...
//-----------------------------------------------------------------------------------------------
        ...
        public ZohoCommentList GetcreditnoteComments(string creditnote_id)
        {
        ...
        /// </summary>
        /// <param name="creditnote_id">The creditnote_id is the identifier of the crditnote.</param>
        /// <param name="newZohoComment">The newZohoComment is the ZohoComment object which is having new comment information.</param>
        /// <returns>ZohoComment object.</returns>
        public ZohoComment AddComment(string creditnote_id, ZohoComment newZohoComment)
        {
            string url = baseAddress + "/" + creditnote_id + "/comments";
            var json = JsonConvert.SerializeObject(newZohoComment);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.post(url, getQueryParameters(jsonstring));
