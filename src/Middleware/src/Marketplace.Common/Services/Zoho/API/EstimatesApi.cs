...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class EstimatesApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter estimates by status.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Sent, FourOverStatus.DRAFT, FourOverStatus.Invoiced, FourOverStatus.Accepted, FourOverStatus.Declined</i> and <i>FourOverStatus.Expired</i></td></tr>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoEstimateList object.</returns>
        public ZohoEstimateList GetEstimates(Dictionary<object, object> parameters)
        {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoEstimate object.</returns>
        public ZohoEstimate Get(string estimate_id, Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="newZohoEstimateInfo">The newZohoEstimateInfo is the ZohoEstimate object with contact_id and item_name are mandatory attributes.</param>
        ...
        /// </param>
        /// <returns>ZohoEstimate object.</returns>
        public ZohoEstimate Create(ZohoEstimate newZohoEstimateInfo, Dictionary<object, object> parameters)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoEstimateInfo);
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <param name="update_info">The update_info is the ZohoEstimate object which contains the update details.</param>
        ...
        /// </param>
        /// <returns>ZohoEstimate object.</returns>
        public ZohoEstimate Update(string estimate_id, ZohoEstimate update_info, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/" + estimate_id;
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the ZohoEstimate.</param>
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <returns>System.String.<br></br>The success message is "ZohoEstimate status has been changed to Sent."</returns>
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <returns>System.String.<br></br>The success message is "ZohoEstimate status has been changed to Accepted."</returns>
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <returns>System.String.<br></br>The success message is "ZohoEstimate status has been changed to Declined."</returns>
        ...
        /// <summary>
        /// ZohoEmail an estimate to the customer. Input json string is not mandatory. If input json string is empty, mail will be send with default mail content.
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        ...
        public string SendEmail(string estimate_id, ZohoEmailNotification zohoEmailDetails, string[] attachment_paths)
        {
        ...
        public ZohoEmail GetEmailContent(string estimate_id, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/" + estimate_id + "/email";
            var responce = ZohoHttpClient.get(url, getQueryParameters(parameters));
        ...
        /// <summary>
        /// Updates the billing ZohoAddress for this estimate alone. You can set this ZohoAddress as default billing ZohoAddress for your customer by specifying 'is_update_customer' param as true.
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <param name="update_info">The update_info is the ZohoAddress object which contains the change details.</param>
        /// <returns>System.String.<br></br>The success message is "Billing ZohoAddress updated."</returns>
        public string UpdateBillingAddress(string estimate_id, ZohoAddress update_info)
        {
        ...
        /// <summary>
        /// Update the shipping ZohoAddress for an existing estimate alone (You can set this ZohoAddress as default shipping ZohoAddress for your customer by specifying 'is_update_customer' param as true).
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <param name="update_info">The update_info is the ZohoAddress object which contains the change details.</param>
        /// <returns>System.String.<br></br>The success message is "Shipping ZohoAddress updated"</returns>
        public string UpdateShippingAddress(string estimate_id, ZohoAddress update_info)
        {
        ...
        /// <returns>System.String.<br></br>The success message is "ZohoEstimate information has been updated."</returns>
...
//--------------------------------------------------------------------------------------------------
        ...
        /// </summary>
        /// <param name="estimate_id">The estimate_id is the identifier of the estimate.</param>
        /// <returns>List of ZohoComment object.</returns>
        public ZohoCommentList GetComments(string estimate_id)
        {
        ...
        public ZohoComment AddComment(string estimate_id, ZohoComment newZohoCommentInfo)
        {
            string url = baseAddress + "/" + estimate_id + "/comments";
        ...
        /// <param name="update_info">The update_info is the ZohoComment object with show_comment_to_clients as requsted attribute.</param>
        /// <returns>ZohoComment object.</returns>
        public ZohoComment UpdateComment(string estimate_id, string comment_id, ZohoComment update_info)
        {
