...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    ///     Create a new recurring ZohoExpense,<br></br>
    ...
    public class RecurringExpensesApi:Api
    {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoRecurringExpenseList object.</returns>
        public ZohoRecurringExpenseList GetRecurringExpenses(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoRecurringExpense object.</returns>
        public ZohoRecurringExpense Get(string recurring_expense_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoRecurringExpense">The newZohoRecurringExpense is the recurringExpense object with amount_id,paid_through_id,recurrence_name,star_date,recurrence_frequency,amount and repeat_every as mandatory attributes.</param>
        /// <returns>ZohoRecurringExpense object.</returns>
        public ZohoRecurringExpense Create(ZohoRecurringExpense newZohoRecurringExpense)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoRecurringExpense);
        ...
        /// </summary>
        /// <param name="recurring_expense_id">The recurring_expense_id is the identifier of the recurrence expnse.</param>
        /// <param name="update_info">The update_info is the ZohoRecurringExpense object which contains the updation information.</param>
        /// <returns>ZohoRecurringExpense object.</returns>
        public ZohoRecurringExpense Update(string recurring_expense_id, ZohoRecurringExpense update_info)
        {
            string url = baseAddress + "/" + recurring_expense_id;
        ...
        /// <summary>
        /// EchoStop an active recurring expense.
        /// </summary>
        /// <param name="recurring_expense_id">The recurring_expense_id is the identifier of the recurrence expnse.</param>
        ...
        /// </param>
        /// <returns>List of ZohoExpense object.</returns>
        public ZohoExpenseList GetExpensesCreated(string recurring_expense_id, Dictionary<object, object> parameters)
        {
        ...
        public ZohoCommentList GetComments(string recurring_expense_id)
        {
