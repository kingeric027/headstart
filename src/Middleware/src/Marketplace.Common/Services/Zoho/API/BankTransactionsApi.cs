...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class BankTransactionsApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td><i>FourOverStatus.All, FourOverStatus.Uncategorized, FourOverStatus.Categorized, FourOverStatus.ManuallyAdded, FourOverStatus.Excluded</i> and <i> FourOverStatus.Matched</i></td></tr>
        /// <tr><td>transaction_type</td><td>ZohoTransaction type to group the list view</td></tr>
        ...
        /// <tr><td>status</td><td>ZohoTransaction status wise list view - All, uncategorized, manually_added, matched, excluded, categorized</td></tr>
        /// <tr><td>reference_number</td><td>Reference Number of the transaction.</td></tr>
        /// <tr><td>sort_column</td><td><i>date</i></td></tr>
        /// </table> 
        /// </param>
        /// <returns>ZohoTransactionList object.</returns> 
        public ZohoTransactionList GetTransactions(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoTransaction object.</returns>
        public ZohoTransaction Get(string transaction_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoTransactionInfo">The newZohoTransactionInfo is the ZohoTransaction object which provides the info to create a transaction as a transaction_type parameter is mandatory.</param>
        /// <returns>ZohoTransaction object.</returns>
        public ZohoTransaction Create(ZohoTransaction newZohoTransactionInfo)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoTransactionInfo);
        ...
        /// <param name="update_info">The update_info is the ZohoTransaction object which is having the information to update the transaction with transaction_type parameter as mandatory.</param>
        /// <returns>ZohoTransaction object.</returns>
        public ZohoTransaction Update(string transaction_id, ZohoTransaction update_info)
        {
            string url = baseAddress + "/" + transaction_id;
        ...
        /// <tr><td>contact</td><td>ZohoContact person name, involved in the transaction.</td></tr>
        /// <tr><td>reference_number</td><td>Reference Number of the transaction.</td></tr>
        /// </table>
        /// </param>
        /// <returns>ZohoMatchingTransactions object.</returns>
        public ZohoMatchingTransactions GetMatchingTransactions(string transaction_id, Dictionary<object, object> parameters)
        {
        ...
        /// <param name="zohoTransactionsToBeMatched">The zohoTransactionsToBeMatched is the list of transactions objects with transaction_id and transaction_type as mandatory.</param>
        ...
        public string MatchATransaction(string transaction_id, ZohoTransactionsToBeMatched zohoTransactionsToBeMatched)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/match";
            var json = JsonConvert.SerializeObject(zohoTransactionsToBeMatched);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.post(url, getQueryParameters(jsonstring));
            return BankTransactionParser.getMessage(responce);
        ...
        public ZohoTransaction GetAssociatedTransactions(string transaction_id, Dictionary<object, object> parameters)
        {
        ...
        /// <param name="zohoTransactionInfo">The zohoTransactionInfo is the information which requires to create a transaction to catogarise with transaction_type as mandatory parameter.</param>
        /// <returns>System.String.<br></br>The success message is "The transaction is now categorized."</returns>
        public string CategorizeAnUncategorizedTransaction(string transaction_id, ZohoTransaction zohoTransactionInfo)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/categorize";
            var json = JsonConvert.SerializeObject(zohoTransactionInfo);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
            var responce = ZohoHttpClient.post(url, getQueryParameters(jsonstring));
            return BankTransactionParser.getMessage(responce);
        ...
        /// <returns>System.String.<br></br>The success message is "The transaction is now categorized."</returns>
        public string CategorizeAsCreditNoteRefunds(string transaction_id, ZohoCreditNote refund_details)
        {
        ...
        /// <returns>System.String.<br></br>The success message is "The transaction is now categorized."</returns>
        public string CategorizeAsVendorpayment(string transaction_id, ZohoVendorPayment payment_details)
        {
        ...
        /// <returns>System.String.<br></br>The success message is "The transaction is now categorized."</returns>
        public string CategorizeAsCustomerPayments(string transaction_id, ZohoCustomerPayment payment_details, Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="transaction_id">The transaction_id is the identifier of the uncategorized transaction.</param>
        /// <param name="zohoExpenseDetails">The zohoExpenseDetails is the Expoense object with account_id,paid_through_account_id and date are mandatory parameters.</param>
        /// <param name="receipt_path">The receipt_path is the reciept for the expense .</param>
        /// <returns>System.String.<br></br> The success message is "The transaction is now categorized."</returns>
        public string CategorizeAsExpense(string transaction_id, ZohoExpense zohoExpenseDetails, string receipt_path)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/categorize/expense";
            var json = JsonConvert.SerializeObject(zohoExpenseDetails);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
        ...
        public string CategorizeAsVendorCreditRefund(string transaction_id,ZohoVendorCreditRefund refund_details)
        {
