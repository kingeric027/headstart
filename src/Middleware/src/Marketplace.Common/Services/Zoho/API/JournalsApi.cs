...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class JournalsApi:Api
    {
        ...
        public ZohoJournalList GetJournals(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoJournal object.</returns>
        public ZohoJournal Get(string journal_id)
        {
        ...
        /// Creates a journal.
        /// </summary>
        /// <param name="newZohoJournalInfo">The newZohoJournalInfo is the ZohoJournal object with journal_date,amount,debit_or_credit as mandatory attributes.</param>
        /// <returns>ZohoJournal object.</returns>
        public ZohoJournal Create(ZohoJournal newZohoJournalInfo)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoJournalInfo);
        ...
        /// </summary>
        /// <param name="journal_id">The journal_id is the identifier of the journal.</param>
        /// <param name="update_info">The update_info is the ZohoJournal object which contains the updation information of specifed journal.</param>
        /// <returns>ZohoJournal object.</returns>
        public ZohoJournal Update(string journal_id, ZohoJournal update_info)
        {
            string url = baseAddress + "/" + journal_id;
