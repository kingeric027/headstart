...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class InvoicesApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter invoices by any status or payment expected date.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.Sent, FourOverStatus.DRAFT, FourOverStatus.OverDue, FourOverStatus.Paid, FourOverStatus.Void, FourOverStatus.Unpaid, FourOverStatus.PartiallyPaid, FourOverStatus.Viewed</i> and <i>Date.PaymentExpectedDate</i></td></tr>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoInvoicesList object.</returns>
        public ZohoInvoicesList GetInvoices(Dictionary<object, object> parameters)
        {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoInvoice object.</returns>
        public ZohoInvoice Get(string invoice_id, Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="newZohoInvoiceInfo">The newZohoInvoiceInfo is the ZohoInvoice object .</param>
        /// <param name="parameters">The parameters is the dictionary object which contains the following optional parameters in the key,value pair forms.<br></br>
        /// <table>
        ...
        /// </table></param>
        /// <returns>ZohoInvoice object.</returns>
        public ZohoInvoice Create(ZohoInvoice newZohoInvoiceInfo, Dictionary<object, object> parameters)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoInvoiceInfo);
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="update_info">The update_info is the ZohoInvoice object which contains the update information.</param>
        /// <param name="parameters">The parameters is the dictionary object which contains the following optional parameters in the key,value pair forms.<br></br>
        /// <table>
        /// <tr><td>ignore_auto_number_generation</td><td>Ignore auto invoice number generation for this invoice. This mandates the invoice number.<br></br>Allowed Values: <i>true</i> and <i>false</i></td></tr>
        /// </table></param>
        /// <returns>ZohoInvoice object.</returns>
        public ZohoInvoice Update(string invoice_id, ZohoInvoice update_info, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/" + invoice_id;
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <returns>System.String<br></br> The success message is "ZohoInvoice status has been changed to Sent."</returns>
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <returns>System.String<br></br> The success message is "ZohoInvoice status has been changed to Void."</returns>
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <returns>System.String<br></br> The success message is "FourOverStatus of invoice changed from void to draft."</returns>
        ...
        /// <summary>
        /// ZohoEmail an invoice to the customer. Input json string is not mandatory. If input json string is empty, mail will be send with default mail content.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="zohoEmailDetails">The zohoEmailDetails is the ZohoEmailNotification object with to_mail_ids as mandatory attribute.</param>
        ...
        public string SendEmail(string invoice_id, ZohoEmailNotification zohoEmailDetails, string[] attachment_paths, Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="zohoContacts">The zohoContacts is the ZohoContacts object with contact_id as a mandatory attribute.</param>
        ...
        public string EmailInvoices(ZohoContacts zohoContacts, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/email";
            var json = JsonConvert.SerializeObject(zohoContacts);
            parameters.Add("JSONString", json);
            var responce = ZohoHttpClient.post(url, getQueryParameters(parameters));
            string responceContent = responce.Content.ReadAsStringAsync().Result;
            return InvoiceParser.getMessage(responce);
        ...
        public ZohoEmail GetEmailContent(string invoice_id, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/" + invoice_id + "/email";
            var responce = ZohoHttpClient.get(url, getQueryParameters(parameters));
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="notify_details">The notify_details is the ZohoEmailNotification object with to_mail_ids as mandatory parameter.</param>
        ...
        public string RemindCustomer(string invoice_id, ZohoEmailNotification notify_details, Dictionary<object, object> parameters)
        {
        ...
        /// </param>
        /// <returns>System.String<br></br> The success message is "Processed! All reminders have been sent." </returns>
        ...
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <returns>ZohoEmail object.</returns>
        public ZohoEmail GetPaymentReminder(string invoice_id)
        {
            string url = baseAddress + "/" + invoice_id + "/paymentreminder";
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <returns>System.String<br></br> The success message is "ZohoInvoice has been written off."</returns>
        ...
        /// <summary>
        /// Updates the billing ZohoAddress for this invoice alone. You can set this ZohoAddress as default billing ZohoAddress for your customer by specifying 'is_update_customer' param as true.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="update_info">The update_info ois the ZohoAddress object which contains the updation information.</param>
        /// <returns>System.String<br></br> The success message is "Billing ZohoAddress updated"</returns>
        public string UpdateBillingAddress(string invoice_id, ZohoAddress update_info)
        {
        ...
        /// <summary>
        /// Updates the shipping ZohoAddress for this invoice. You can set this ZohoAddress as default shipping ZohoAddress for your customer by specifying 'is_update_customer' param as true.
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="update_info">The update_info ois the ZohoAddress object which contains the updation information.</param>
        /// <returns>System.String<br></br> The success message is "Shipping ZohoAddress updated"</returns>
        public string UpdateShippingAddress(string invoice_id, ZohoAddress update_info)
        {
        ...
        /// </summary>
        /// <returns>List of ZohoTemplate objects.</returns>
        ...
        /// <returns>System.String<br></br> The success message is "ZohoInvoice information has been updated." </returns>
...
//-------------------------------------------------------------------------------------------------------
        ...
        public ZohoPaymentList GetPayments(string invoice_id)
        {
        ...
        public ZohoCreditNoteList GetCreditsApplied(string invoice_id)
        {
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="credits_to_apply">The credits_to_apply is the ZohoUseCredits object which contains the credits information to apply.</param>
        /// <returns>ZohoUseCredits object.</returns>
        public ZohoUseCredits AddCredits(string invoice_id, ZohoUseCredits credits_to_apply)
        {
...
//----------------------------------------------------------------------------------------------------------------
        ...
        public ZohoCommentList GetComments(string invoice_id)
        {
        ...
        /// </summary>
        /// <param name="invoice_id">The invoice_id is the identifier of the invoice.</param>
        /// <param name="newZohoCommentInfo">The newZohoCommentInfo is the ZohoComment object which contains the information to add a new comment.</param>
        /// <returns>ZohoComment object.</returns>
        public ZohoComment AddComment(string invoice_id, ZohoComment newZohoCommentInfo)
        {
            string url = baseAddress + "/" + invoice_id + "/comments";
        ...
        /// <param name="update_info">The update_info is the ZohoComment object which contains the updation information.</param>
        /// <returns>ZohoComment object.</returns>
        public ZohoComment UpdateComment(string invoice_id, string comment_id, ZohoComment update_info)
        {
