...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    /// Create a ZohoBill for the vendor.<br></br>
    ...
    public class BillsApi:Api
    {
        ...
        /// <tr><td>filter_by</td><td>Filter bills by any status.<br></br>Allowed Values: <i>FourOverStatus.All, FourOverStatus.PartiallyPaid, FourOverStatus.Paid, FourOverStatus.Overdue, FourOverStatus.Void </i>and <i>FourOverStatus.Open</i></td></tr>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoBillList object.</returns>
        public ZohoBillList GetBills(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoBill object.</returns>
        public ZohoBill Get(string bill_id)
        {
        ...
        /// </summary>
        /// <param name="newZohoBillInfo">The newZohoBillInfo is the bill object which contains the vendor_id,account_id and bill_number as mandatory parameters.</param>
        /// <param name="attachment_path">The attachment_path is the receipt file to the bill.</param>
        /// <returns>ZohoBill object.</returns>
        public ZohoBill Create(ZohoBill newZohoBillInfo, string attachment_path)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoBillInfo);
        ...
        /// <returns>ZohoBill object.</returns>
        public ZohoBill Update(string bill_id, ZohoBill update_info, string attachment_path)
        {
            string url = baseAddress + "/" + bill_id;
        ...
        /// <summary>
        /// Updates the billing ZohoAddress for this bill.
        /// </summary>
        /// <param name="bill_id">The bill_id is the identifier of the bill .</param>
        /// <param name="update_info">The update_info is the ZohoAddress object which contains the information to be update.</param>
        /// <returns>System.String.<br></br>The success message is "Billing ZohoAddress updated."</returns>
        public string UpdateBillingAddress(string bill_id, ZohoAddress update_info)
        {
            string url = baseAddress + "/" + bill_id + "/ZohoAddress/billing";
            var json = JsonConvert.SerializeObject(update_info);
            var jsonstring = new Dictionary<object, object>();
            jsonstring.Add("JSONString", json);
        ...
        /// <returns>List of ZohoPayment object.</returns>
        public ZohoPaymentList GetPayments(string bill_id)
        {
        ...
        /// <param name="credits_info">The credits_info is the ZohoUseCredits object which is having the credits info with amount_applied as mandatory parameter.</param>
        /// <returns>System.String.<br></br>The success message is "Credits have been applied to the bill(s)."</returns>
        public string ApplyCredits(string bill_id, ZohoUseCredits credits_info)
        {
        ...
        public ZohoCommentList GetComments(string bill_id)
        {
        ...
        /// </summary>
        /// <param name="bill_id">The bill_id is the identifier of the bill.</param>
        /// <param name="newZohoCommentInfo">The newZohoCommentInfo is the ZohoComment object which is having the comment information.</param>
        /// <returns>System.String.<br></br>The success message is "Comments added." </returns>
        public string AddComment(string bill_id, ZohoComment newZohoCommentInfo)
        {
            string url = baseAddress + "/" + bill_id + "/comments";
