...
namespace Marketplace.Common.Services.Zoho.API
{
    ...
    public class BaseCurrencyAdjustmentsApi:Api
    {
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoBaseCurrencyAdjustmentsList object.</returns>
        public ZohoBaseCurrencyAdjustmentsList GetBaseCurrencyAdjustments(Dictionary<object, object> parameters)
        {
        ...
        /// <returns>ZohoBaseCurrencyAdjustment object.</returns>
        public ZohoBaseCurrencyAdjustment Get(string base_currency_adjustment_id)
        {
        ...
        /// </param>
        /// <returns>ZohoBaseCurrencyAdjustment object.</returns>
        public ZohoBaseCurrencyAdjustment GetBaseCurrencyAdjustmentAccounts(Dictionary<object, object> parameters)
        {
        ...
        /// </summary>
        /// <param name="newZohoBaseCurrencyAdjustmentInfo">The newZohoBaseCurrencyAdjustmentInfo is the ZohoBaseCurrencyAdjustment object which contains the currency_id,adjustment_date,exchange_rate and notes as mandatory parameters.</param>
        ...
        /// </table>
        /// </param>
        /// <returns>ZohoBaseCurrencyAdjustment.</returns>
        public ZohoBaseCurrencyAdjustment Create(ZohoBaseCurrencyAdjustment newZohoBaseCurrencyAdjustmentInfo, Dictionary<object, object> parameters)
        {
            string url = baseAddress;
            var json = JsonConvert.SerializeObject(newZohoBaseCurrencyAdjustmentInfo);
