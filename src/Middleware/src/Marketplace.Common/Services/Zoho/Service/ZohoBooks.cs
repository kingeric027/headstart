using Marketplace.Common.Services.Zoho.API;

namespace Marketplace.Common.Services.Zoho.Service
{
    /// <summary>
    ...
    public class ZohoBooks
    {
        ...
        /// <summary>
        /// Initialize ZohoBooks using user's authtoken and ZohoOrganization id.
        /// </summary>
