...
namespace Marketplace.Common.Commands
{
    public class UserGroupAssignmentSyncCommand : SyncCommand, IWorkItemCommand
    {
        ...
        public UserGroupAssignmentSyncCommand(IAppSettings settings, LogQuery log, IOrderCloudClient oc) : base(settings, log)
        {
            _oc = oc;
        }
        ...
        public async Task<JObject> CreateAsync(WorkItem wi)
        {
            ...
            try
            {
                await _oc.UserGroups.SaveUserAssignmentAsync("buyerid", obj, wi.Token);
        ...
        public async Task<JObject> GetAsync(WorkItem wi)
        {
            try
            {
                var response = await _oc.UserGroups.ListUserAssignmentsAsync("buyerid", userGroupID: wi.RecordId, wi.Token);
