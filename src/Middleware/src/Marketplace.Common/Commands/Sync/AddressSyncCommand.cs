...
namespace Marketplace.Common.Commands
{
    public class AddressSyncCommand : SyncCommand, IWorkItemCommand
    {
        ...
        {
            var obj = wi.Current.ToObject<MarketplaceAddressBuyer>();
            try
            {
                obj.ID = wi.RecordId;
        ...
        {
            var obj = JObject.FromObject(wi.Current).ToObject<MarketplaceAddressBuyer>();
            try
            {
        ...
        {
            var obj = JObject.FromObject(wi.Diff).ToObject<PartialAddress>();
            try
            {
