...
namespace Marketplace.Common.Commands
{
    public class AddressSyncCommand : SyncCommand, IWorkItemCommand
    {
        ...
        public AddressSyncCommand(AppSettings settings, LogQuery log, IOrderCloudClient oc, IAssetQuery assets) : base(settings, oc, assets, log)
        {
            _oc = oc;
            _assets = assets;
        }
        ...
        {
            var obj = wi.Current.ToObject<MarketplaceAddressBuyer>(OrchestrationSerializer.Serializer);
            try
            {
