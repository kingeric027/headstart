...
namespace Marketplace.Common.Commands
{
    public class BuyerSyncCommand : SyncCommand, IWorkItemCommand
    {
        ...
        public BuyerSyncCommand(AppSettings settings, LogQuery log, IOrderCloudClient oc, IAssetQuery assets) : base(settings, oc, assets, log)
        {
            _oc = oc;
            _assets = assets;
        }
        ...
        {
            var obj = wi.Current.ToObject<MarketplaceBuyer>();
            try
            {
                obj.ID = wi.RecordId;
        ...
        {
            var obj = wi.Current.ToObject<MarketplaceBuyer>(OrchestrationSerializer.Serializer);
            try
            {
