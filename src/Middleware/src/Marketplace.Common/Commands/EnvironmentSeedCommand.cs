...
namespace Marketplace.Common.Commands
{
    ...
    public class EnvironmentSeedCommand : IEnvironmentSeedCommand
    {
        ...
        static readonly List<SecurityProfile> DefaultSecurityProfiles = new List<SecurityProfile>() {
            ...
            new SecurityProfile(){ Name = "MPMeSupplierUserGroupAdmin", CustomRoles = { "MPMeSupplierUserGroupAdmin" }, ID = "MPMeSupplierUserGroupAdmin", Roles = { ApiRole.SupplierReader, ApiRole.SupplierUserGroupAdmin } },
        };
