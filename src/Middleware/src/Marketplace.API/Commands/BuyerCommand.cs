...
namespace Headstart.API.Commands
{
    ...
    {
        Task<SuperHSBuyer> Create(SuperHSBuyer buyer, string token, bool isSeedingEnvironment = false);
    ...
    public class HSBuyerCommand : IHSBuyerCommand
    {
        ...
        public async Task<SuperHSBuyer> Create(SuperHSBuyer superBuyer, string token, bool isSeedingEnvironment = false)
        {
            var createdBuyer = await CreateBuyerAndRelatedFunctionalResources(superBuyer.Buyer, token, isSeedingEnvironment);
